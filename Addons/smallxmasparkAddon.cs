...
{
	public class smallxmasparkAddon : BaseAddon
	{
        private static int[,] m_AddOnSimpleComponents = new int[,] {
			...
			, {7038, -2, 3, 0}, {6077, 0, 2, 0}, {6077, 1, 2, 0}// 80	87	88	
			, {6077, 2, 2, 0}, {6089, 1, 4, 0}, {6089, 2, 4, 0}// 89	90	91	
			, {6077, 0, 3, 0}, {6077, 1, 3, 0}, {6077, 2, 3, 0}// 92	93	94	
			, {6087, 3, 4, 0}, {6090, -3, 2, 0}, {6090, -3, 3, 0}// 95	96	97	
			, {6092, 3, 2, 0}, {6092, 3, 3, 0}, {6089, 0, 4, 0}// 98	99	100	
			, {6088, -3, 4, 0}, {6077, -1, 2, 0}, {6077, -1, 3, 0}// 101	102	103	
			, {6089, -1, 4, 0}, {6089, -2, 4, 0}, {6077, -2, 2, 0}// 104	105	106	
			, {6077, -2, 3, 0}, {11229, 0, 3, 0}, {11232, 2, 3, 0}// 107	108	109	
			, {11230, 2, 2, 0}// 110	
		};
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new smallxmasparkAddonDeed();
			}
		}

		[ Constructable ]
		public smallxmasparkAddon()
		{
			...
			AddComplexComponent( (BaseAddon) this, 9001, -1, 2, 0, 978, -1, "", 1);// 72
			AddComplexComponent( (BaseAddon) this, 6255, 0, 3, 0, 1153, -1, "Snow Ball", 1);// 73
			AddComplexComponent( (BaseAddon) this, 6255, 0, 3, 0, 1153, -1, "Snow Ball", 1);// 74
			AddComplexComponent( (BaseAddon) this, 6255, 0, 2, 0, 1153, -1, "Snow Ball", 1);// 75
			AddComplexComponent( (BaseAddon) this, 6255, 1, 2, 0, 1153, -1, "Snow Ball", 1);// 76
			AddComplexComponent( (BaseAddon) this, 6255, 1, 3, 0, 1153, -1, "Snow Ball", 1);// 77
			AddComplexComponent( (BaseAddon) this, 6255, 2, 3, 0, 1153, -1, "Snow Ball", 1);// 78
			AddComplexComponent( (BaseAddon) this, 6255, 2, 2, 0, 1153, -1, "Snow Ball", 1);// 79
			AddComplexComponent( (BaseAddon) this, 7878, -1, 4, 30, 2673, -1, "flashing lights", 1);// 81
			AddComplexComponent( (BaseAddon) this, 7878, -1, 4, 25, 2581, -1, "flashing lights", 1);// 82
			AddComplexComponent( (BaseAddon) this, 7878, -1, 4, 20, 2673, -1, "flashing lights", 1);// 83
			AddComplexComponent( (BaseAddon) this, 7878, -1, 4, 15, 2581, -1, "flashing lights", 1);// 84
			AddComplexComponent( (BaseAddon) this, 10299, -2, 3, 32, 2293, -1, "Tree Topper", 1);// 85
			AddComplexComponent( (BaseAddon) this, 7878, -1, 4, 35, 2581, -1, "flashing lights", 1);// 86

		}

		public smallxmasparkAddon( Serial serial ) : base( serial )
		{
		}
	...
	public class smallxmasparkAddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new smallxmasparkAddon();
			}
		}

		[Constructable]
		public smallxmasparkAddonDeed()
		{
			Name = "smallxmaspark";
		}

		public smallxmasparkAddonDeed( Serial serial ) : base( serial )
		{
		}
