...
namespace Server.Items
{
	public class xmasgazebo3Addon : BaseAddon
	{
        private static int[,] m_AddOnSimpleComponents = new int[,] {
			...
			, {10508, 2, 3, 30}, {9079, 4, -3, 2}, {9079, 4, 4, 2}// 113	115	116	
					};
		...
		public override BaseAddonDeed Deed
		{
			get
			{
				return new xmasgazebo3AddonDeed();
			}
		}

		[ Constructable ]
		public xmasgazebo3Addon()
		{
		...
		public xmasgazebo3Addon( Serial serial ) : base( serial )
		{
		}
	...
	public class xmasgazebo3AddonDeed : BaseAddonDeed
	{
		public override BaseAddon Addon
		{
			get
			{
				return new xmasgazebo3Addon();
			}
		}

		[Constructable]
		public xmasgazebo3AddonDeed()
		{
			Name = "xmasgazebo3";
		}

		public xmasgazebo3AddonDeed( Serial serial ) : base( serial )
		{
		}
