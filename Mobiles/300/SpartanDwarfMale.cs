...
namespace Server.Mobiles
{
	...
	public class SpartanDwarfMale : BaseCreature
	{

		public override bool ShowFameTitle{ get{ return false; } }

		[Constructable]
		public SpartanDwarfMale() : base( AIType.AI_Melee, FightMode.Aggressor, 10, 1, 0.2, 0.2 )
		{
		...
		public SpartanDwarfMale( Serial serial ) : base( serial )
		{
		}
