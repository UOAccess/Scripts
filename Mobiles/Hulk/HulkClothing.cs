...
{
	public class HulkClothing : BaseOuterTorso
	{
		[Constructable]
		public HulkClothing() : base( 0x2684 )	// Hooded Shroud
		{	
			Hue = 1271;	// Darkish Green
			Name = "The Incredible Hulk";
			Attributes.BonusStr = 10;
		}

		public HulkClothing( Serial serial ) : base( serial )
		{
		}
		...
		public override bool OnEquip( Mobile from )
		{
			...
			from.SendMessage( "You feel the power of the Hulk taking over your body!" );
			...
			{
				from.SendMessage( 1154, "The transformation was incomplete! The Hulk is too huge to ride mounts!!" );
			}
			return true;
		}
